...
public class CancelOrder extends HttpServlet {
 ...
 @Override
    ...
    session.setAttribute("cancelledorderDetailID", orderDetailID);
    session.setAttribute("cancelledOrderID", orderID);
        ...
        try {
            ...
            UserDTO userDto = udao.searchByID(o.getUserID());
                    SendCancelBookingMail sm = new SendCancelBookingMail();
        ...
        if (test) {
              ...
              response.sendRedirect("CancelBookingServlet");
        } 
