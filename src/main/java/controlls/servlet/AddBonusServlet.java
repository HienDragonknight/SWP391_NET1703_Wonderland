 ...
 */
@MultipartConfig
@WebServlet(name = "AddBonusServlet", urlPatterns = {"/AddBonusServiceServlet"})
public class AddBonusServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddBonusServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            if (part.getSize() > 0) {
                String folderSaveFile = "/views/products/bonus_service_image";
            ...
            if(serviceName!=null && servicePriceParameter!=null&& descriptions!=null && imageSave!=null){
                BonusServiceDTO bonus = new BonusServiceDTO(serviceName, servicePrice, descriptions, imageSave);
