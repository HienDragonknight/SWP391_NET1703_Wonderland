                    ...
                    <div class="page-main-fullwidth">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-info">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label text-blue" for="center_code">
                                                            Trung tâm WonderLand
                                                        </label>


                                                        <select class="form-select-input form-control" id="center" name="location_option">
                                                            <%
                                                                List<LocationDTO> locationList = (List<LocationDTO>) request.getAttribute("BONUS_SERVICE_LIST");
                        ...
                        <div id="myModal" class="modal modal-centered">
                            <div class="modal-content">
                                <img id="modalImg" class="modal-img" alt="modal-img">
                                <button class="modal-close rounded-circle" id="modalClose">×</button>
                            </div>
                        </div>

                        <!-- modal info -->
                        <div class="modal modal-xl" id="infoModal">
