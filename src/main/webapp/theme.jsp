<%-- 
    Document   : theme
    Created on : Mar 13, 2024, 6:47:43 PM
    Author     : 84335
--%>
        ...
        <main>
            <div class="column">
                ...
                <div class="main-contain">
                    <%
                        List<ThemeDTO> result = (List<ThemeDTO>) session.getAttribute("THEME_LIST");

                        if (result != null) {
                            int count = 0;
                            for (ThemeDTO themeDTO : result) {
                    ...
                    <div class="row">
                        <% }%>
                        <div class="service">
                            <img src="image/Theme/<%= themeDTO.getThemeImage()%>" alt="alt" />
